...
| `TARGET_ERROR` | The runtime target could not be initialized | Visor daemon not running, Appium unreachable, missing driver dependencies, unsupported platform |
...
- Visor daemon is not running for a real runtime command
